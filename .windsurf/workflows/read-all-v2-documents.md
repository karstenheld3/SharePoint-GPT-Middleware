---
description: Read all .md files in workspace/.windsurf/rules
...
Then read:
- /: SOPS.md, _V2_SPEC_ROUTERS.md, _V2_SPEC_CRAWLER.md, _V2_SPEC_COMMON_UI_FUNCTIONS.md
- /src/: app.py, common_utility_functions.py, hardcoded_config.py
- /src/routers_v2/: jobs.py, common_job_functions_v2.py, common_logging_functions_v2.py
