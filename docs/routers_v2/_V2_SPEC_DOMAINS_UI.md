...
Note: Table rendering functions (`reloadItems()`, `renderItemsTable()`, `renderItemRow()`) are auto-generated by `generate_ui_page()` in common_ui_functions_v2.py. The following are router-specific additions:
