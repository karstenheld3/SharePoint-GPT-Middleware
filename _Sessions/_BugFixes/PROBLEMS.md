...
**GLOB-PR-0006: Query2 HTML table not responsive (wider than viewport)**
...
**GLOB-PR-0005: Misleading "Vector store not found" error when OpenAI backend unavailable**
...
**GLOB-PR-0004: Crawler selftest fails after V2CR-SP01 list export changes**
...
**GLOB-PR-0003: Selftest dialog and console close automatically after completion**
...
**GLOB-PR-0001: Domains UI not updated after creating new domain**
...
**GLOB-PR-0002: domainsState cache not updated after CRUD operations**
- **History**: Added 2026-02-05 15:18 | Resolved 2026-02-05 15:52
...
**[2026-03-06 14:55]**
- Added: GLOB-PR-0004 (Crawler selftest snapshot expectations) - Resolved

**[2026-03-06 14:30]**
- Updated: GLOB-PR-0003 - Added pattern to V2_INFO_IMPLEMENTATION_PATTERNS.md, fixed all routers

**[2026-03-06 14:27]**
- Added: GLOB-PR-0003 (Selftest dialog/console auto-close) - Resolved

**[2026-02-05 15:18]**
- Added: GLOB-PR-0001 (UI not updated after create)
- Added: GLOB-PR-0002 (domainsState cache stale)
