...
**PR-006: Query2 HTML table not responsive (wider than viewport)**
...
**PR-005: Misleading "Vector store not found" error when OpenAI backend unavailable**
...
**PR-004: Crawler selftest fails after V2CR-SP01 list export changes**
...
**PR-003: Selftest dialog and console close automatically after completion**
...
**PR-001: Domains UI not updated after creating new domain**
...
**PR-002: domainsState cache not updated after CRUD operations**
- **History**: Added 2026-02-05 15:18 | Resolved 2026-02-05 15:52
...
**[2026-03-06 14:55]**
- Added: PR-004 (Crawler selftest snapshot expectations) - Resolved

**[2026-03-06 14:30]**
- Updated: PR-003 - Added pattern to V2_INFO_IMPLEMENTATION_PATTERNS.md, fixed all routers

**[2026-03-06 14:27]**
- Added: PR-003 (Selftest dialog/console auto-close) - Resolved

**[2026-02-05 15:18]**
- Added: PR-001 (UI not updated after create)
- Added: PR-002 (domainsState cache stale)
