...
from routers_v1 import crawler, inventory, domains
...
def create_app() -> FastAPI:
  ...
  # Include Domains V2 router under /v2
  try:
    app.include_router(domains_v2.router, tags=["Domains"], prefix=v2_router_prefix)
    domains_v2.set_config(config, v2_router_prefix)
    log_function_output(log_data, f"Domains V2 router included at {v2_router_prefix}")
  except Exception as e:
  ...
  # Include Crawler V2 router under /v2
  try:
    app.include_router(crawler_v2.router, tags=["Crawler V2"], prefix=v2_router_prefix)
    crawler_v2.set_config(config, v2_router_prefix)
    log_function_output(log_data, f"Crawler V2 router included at {v2_router_prefix}")
  except Exception as e:
...
<body>
  ...
  <ul>
    ...
    <li><a href="/v2/jobs">/v2/jobs</a> - Jobs Monitoring (<a href="/v2/jobs?format=json">JSON</a> + <a href="/v2/jobs?format=html">HTML</a> + <a href="/v2/jobs?format=ui">UI</a> + <a href="/v2/jobs/get">Get</a> + <a href="/v2/jobs/monitor">Monitor</a> + <a href="/v2/jobs/result">Result</a> + <a href="/v2/jobs/control">Control</a> + <a href="/v2/jobs/delete">Delete</a>)</li>
    <li><a href="/v2/domains">/v2/domains</a> - Knowledge Domains (<a href="/v2/domains?format=json">JSON</a> + <a href="/v2/domains?format=html">HTML</a> + <a href="/v2/domains?format=ui">UI</a> + <a href="/v2/domains/get">Get</a> + <a href="/v2/domains/create">Create</a> + <a href="/v2/domains/update">Update</a> + <a href="/v2/domains/delete">Delete</a> + <a href="/v2/domains/selftest?format=stream">Selftest</a>)</li>
    <li><a href="/v2/sites">/v2/sites</a> - Sites Management (<a href="/v2/sites?format=json">JSON</a> + <a href="/v2/sites?format=html">HTML</a> + <a href="/v2/sites?format=ui">UI</a> + <a href="/v2/sites/get">Get</a> + <a href="/v2/sites/create">Create</a> + <a href="/v2/sites/update">Update</a> + <a href="/v2/sites/delete">Delete</a>)</li>
    <li><a href="/v2/reports">/v2/reports</a> - Report Archives (<a href="/v2/reports?format=json">JSON</a> + <a href="/v2/reports?format=html">HTML</a> + <a href="/v2/reports?format=ui">UI</a> + <a href="/v2/reports/get">Get</a> + <a href="/v2/reports/file">File</a> + <a href="/v2/reports/view?report_id=crawls/example&format=ui">View</a> + <a href="/v2/reports/download">Download</a> + <a href="/v2/reports/delete">Delete</a>)</li>
    <li><a href="/v2/crawler">/v2/crawler</a> - SharePoint Crawler (<a href="/v2/crawler?format=json">JSON</a> + <a href="/v2/crawler?format=ui">UI</a> + <a href="/v2/crawler/crawl?format=stream">Crawl</a> + <a href="/v2/crawler/download?format=stream">Download</a> + <a href="/v2/crawler/process?format=stream">Process</a> + <a href="/v2/crawler/embed?format=stream">Embed</a> + <a href="/v2/crawler/selftest?format=stream">Selftest</a>)</li>
  </ul>
