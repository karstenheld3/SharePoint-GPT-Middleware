...
async def process_files(request: Request):
  ...
  async def stream_generator():
    ...
    writer = StreamingJobWriter(persistent_storage_path=persistent_storage_path, router_name="demorouter", action=endpoint, object_id=None, source_url=source_url, router_prefix=router_prefix, buffer_size=CRAWLER_HARDCODED_CONFIG.PERSISTENT_STORAGE_LOG_EVENTS_PER_WRITE)
